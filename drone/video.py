...
class Video:
    def __init__(self):
        ...
        self.up = Temp(self.screen, 1, (255, 255, 255), 0.5, (self.W/2-20, 20, 10, 10))
        self.down = Temp(self.screen, 0.25, (255, 255, 255), 0.5, (self.W/2-30, self.H-20, 10, 10))
        self.left = Temp(self.screen, 0.125, (255, 255, 255), 0.5, (20, self.H/2-20, 10, 10))
        self.right = Temp(self.screen, 0.5, (255, 255, 255), 0.5, (self.W-20/2-20, self.H/2-30, 10, 10))
        self.up.start()
        self.left.start()
        self.down.start()
        self.right.start()
